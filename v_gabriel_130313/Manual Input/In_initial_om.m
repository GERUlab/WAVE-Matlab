...
OC1 = [1:20];soil_om(OC1,5:6) =soil_om(OC1,5:6)*2;
OC1 = [21:40];soil_om(OC1,5:6) =soil_om(OC1,5:6)*0.5;
OC2 = [41:60];soil_om(OC2,5:6) =soil_om(OC2,5:6)/100;
OC3= [60:ncs];soil_om(OC3,5:6) =soil_om(OC3,5:6)/100;
% mineralisaton
