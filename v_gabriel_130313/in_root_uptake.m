...
p2h = -500;     %below this pressure head no longer optimal at high evaporative demand (=epa_high)
p2l = -500 ;    %below this pressure head no longer optimal at low evaporative demand (=epa_low)
p3 =-16000 ;     %below this pressure head no extraction (= wilting point)
epa_high = 0.5 ; %(L T-1)
epa_low = 0.1 ; %(L T-1)
