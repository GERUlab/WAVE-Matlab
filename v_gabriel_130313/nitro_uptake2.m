function[uptakem,uptakei,tot_upt, first_time, uptake_matrix,rdens]=nitro_uptake2(csol,dt,dx,harvest_date,...
...
%rnmaxp = 999999999*NDemand*PLM2*PropFact*10 ;%test
...
[rdens,drza]= calc_rdens(plant_uptake_param,ncs,dx,drz);
