function [applic_boolean,BOUNDARY_CONDITIONS_MATRIX  , acsolio , acsolmo ,...
        ...
        wcio , wciob , wcma , wcmah , wcmo , wcmob , wco , wcob , wcp , wdepsol,initsol,und,unc]=...
        runwave_optmin(BOUNDARY_CONDITIONS_MATRIX  , Smax_given , Smax_param , acsolio , acsolmo ,...
...
A = [t,dt,tmax,temp,dx,nsol,ncs,WC,rtex,cm,cim,csol,cs,acsolmo,acsolio,wat_flxs,ph,...
      ...
      plant_date,harvest_date,isucr,simplant, uptakem, uptakei,minerm,mineri, nitrifi,...
      denitm, deniti, hydro_uream, hydro_ureai, volatm, volati, decnorg, deccorg,...
      carbman, carblit,rnitman, rnitlit,ddepsol, wdepsol, fsol, conirsol,...
