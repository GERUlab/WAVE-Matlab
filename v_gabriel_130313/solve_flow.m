function [ph,wat_flxs,dt,iter,runoff,no_conv,WC,bctop_changed,bcbot_changed,pond,...
  phsurf,flxar,boco_top_type,boco_bot_type,rtex,EPRA,boco_top] =...
   ...
   simplant,units,plant_date,harvest_date,ncbot,drz,epa);
...
[WC,kh,CH,rtex,EPRA]=state_var(ph,soil_parameters,dt,0,t,simplant,dx,units,plant_date,harvest_date,drz,epa);
phB = ph;WCB = WC;
...
[seep,boco_top_type,boco_bot_type,dt,bctop_changed,...
    ...
    boco_bot_type,boco_top]=check_bc(wat_flxs,ph,kh_in,compartiments_number,dx_inter,pond,phsa,...
