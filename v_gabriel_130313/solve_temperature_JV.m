function [temp, temptopp] = solve_temperature_JV(dt, dx, ncomp, t, WC, wcp, temp, soil_parameters,temptopp,tmax,units,solute_param1,temp_BC,temp_table)
