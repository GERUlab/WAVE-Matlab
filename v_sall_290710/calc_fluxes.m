function [wat_flxs,iter] = calc_fluxes (ph,kh_in,dt,phsurf,pond,flxsbot,phbot,flxar,...
   boco_top_type,boco_bot_type,maxiter,dx_inter,compartiments_number,iter,t, BOUNDARY_CONDITIONS_MATRIX)

% CALC_FLUXES   Calculates the soil water fluxes across the soil nodes
%
%
%IN: 
...
% modified by M. Sall 25/11/09 (in case of groundwater)
