function [top_OK, bot_OK,bctop_changed,bcbot_changed,phsurf,phbot,flxsbot,boco_top_type,...
      boco_bot_type]=check_bc(wat_flxs,ph,kh_in,ncs,dx_inter,pond,phsa,...
   	flxar,boco_top_type,boco_bot_type,seep,phsurf,phbot,flxsbot,bctop_changed,...
      bcbot_changed); 
   
%CHECK_BC    Check if BC changed during iteration
%
%IN:
...
if flxar<0 & pond==0;    %Ajout pour cas comparaison WAVE 
    boco_top_type=2;
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
